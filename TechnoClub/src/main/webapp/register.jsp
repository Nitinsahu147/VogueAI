...
<!-- Luxury Background -->
  ...
  <div class="auth-card">
    <h2 class="auth-title"><i class="fas fa-user-plus"></i> Register</h2>
    <!-- Important: Use RegisterServlet here -->
    <form action="RegisterServlet" method="post">
      ...
      <button type="submit" class="btn-register btn-luxury w-100">Register</button>
    </form>
